...
REM ---------------- CONFIG ----------------
set "SRC=input.mov"
set "OUT_FOLDER=ATS_4K_VERTICAL_444_10bit_NVENC_250M"
...
REM ---------------- VIDEO NAME ----------------
set "CLIP_NAME=American Truck Simulator International LoneStar High Rise Sleeper 500hp 373kW 13 speeds 2026-02-11 13-44-09 DriveHost24 Team 2026 DriveHost24"
