...
REM ---------------- VIDEO NAME ----------------
set "CLIP_NAME=Euro Truck Simulator 2 Renault T High Sleeper 440hp 324kW 12 speeds 2025-11-25 13-48-15 DriveHost24 Team 2025 DriveHost24"
...
for %%F in (tmp_segments\clip_*.mov) do (
    ...
    ffmpeg -y -hwaccel cuda -i "%%F" ^
      ...
      "%OUT_FOLDER%\_!BASE!%CLIP_NAME%_4K60_vertical_444_10bit_1G.mov"
