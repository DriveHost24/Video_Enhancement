...
set "PROFILE=rext"
set "PRESET=p7"
set "TARGET_BITRATE=80M"

REM ---------------- VIDEO NAME ----------------
set "CLIP_NAME=Euro Truck Simulator 2 Mercedes New Actros GigaSpace 510 hp (375kW) 12 speeds 2026-01-26 14-48-51 DriveHost24 Team 2025 DriveHost24"
